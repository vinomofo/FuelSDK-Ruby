...
module SOAPClient
  ...
  class GlobalOptions < Options
    ...
    # The logger to use. Defaults to a SOAPClient::Logger instance.
    def logger(logger)
  ...
  class LocalOptions < Options
    ...
    # SOAP message tag (formerly known as SOAP input tag). If it's not set, SOAPClient retrieves the name from
