...
require "soap_client/builder"
require "soap_client/response"
require "soap_client/log_message"
...
module SOAPClient
  class Operation
    ...
    def call(locals = {}, &block)
      ...
      response = SOAPClient.notify_observers(@name, builder, @globals, @locals)
