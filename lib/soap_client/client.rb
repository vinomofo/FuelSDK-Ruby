require "soap_client/operation"
require "soap_client/request"
require "soap_client/options"
require "soap_client/block_interface"
require "wasabi"
  ...
  class Client
    ...
    def raise_version1_initialize_error!(object)
      raise InitializationError,
        "Some code tries to initialize SOAPClient with the #{object.inspect} (#{object.class}) \n" \
        "SOAPClient 2 expects a Hash of options for creating a new client and executing requests.\n" \
    ...
    def raise_initialization_error!
      raise InitializationError,
            ...
            "SOAPClient.client(wsdl: '/Users/me/project/service.wsdl')                              # to use a local WSDL document\n" \
            "SOAPClient.client(wsdl: 'http://example.com?wsdl')                                     # to use a remote WSDL document\n" \
            "SOAPClient.client(endpoint: 'http://example.com', namespace: 'http://v1.example.com')  # if you don't have a WSDL document"
    end
